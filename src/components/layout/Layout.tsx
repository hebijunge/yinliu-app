      ...
      <div className="flex-1 flex overflow-hidden">
        ...
        {sidebarOpen && (
          <div className="lg:hidden fixed inset-0 z-50 flex">
            <div
              className="w-[var(--sidebar-width)] bg-[var(--bg-secondary)] h-full"
        ...
        <main className="flex-1 overflow-y-auto overflow-x-hidden page-enter">
          {/* Mobile Header */}
          <div className="lg:hidden flex items-center justify-between px-5 py-4 border-b border-[var(--border-subtle)] bg-[var(--bg-primary)]/80 backdrop-blur-md sticky top-0 z-30">
            <button
          ...
          <div className="p-5 lg:p-8 pb-28 lg:pb-[calc(var(--player-height)+1.5rem)]">
            {children}
          </div>
        </main>
      </div>
