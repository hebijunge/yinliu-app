...
function resetStreamEnv(netOpts) {
  globalThis.__streamTest = {
    audios: [],
    cache: {
      data: new Map(),
      calls: { appendData: 0, writeData: 0, readAsBlobUrl: 0, getOrCreateEntry: 0, markActive: 0, markInactive: 0 },
    },
    net: { headDelayMs: 20, chunkDelaysMs: [30, 30], fileSize: 768 * 1024, log: [], ...netOpts },
  };
...
async function runEngineTests() {
  ...
  {
    globalThis.__engineTest = { audios: [], streaming: { loads: [], suppress: 0, resetCount: 0, playCalls: 0, prefetch: [], callbacks: null }, linkCalls: [] };
    global.Audio = makeEngineAudioClass();
